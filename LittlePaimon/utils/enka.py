...
from LittlePaimon.utils import get_name_by_id
from LittlePaimon.config import ENKA_INFO, JSON_DATA

role_element = load_json(JSON_DATA / 'role_element.json')
role_skill = load_json(JSON_DATA / 'role_skill.json')
role_talent = load_json(JSON_DATA / 'role_talent.json')
weapon = load_json(JSON_DATA / 'weapon.json')
prop_list = load_json(JSON_DATA / 'prop.json')
artifact_list = load_json(JSON_DATA / 'artifact.json')
ra_score = load_json(JSON_DATA / 'score.json')


class PlayerInfo:
    def __init__(self, uid: str):
        self.path = ENKA_INFO / f'{uid}.json'

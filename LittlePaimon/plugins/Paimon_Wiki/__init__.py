...
from LittlePaimon.utils import get_match_alias
from LittlePaimon.utils import load_json_from_url
...
def create_choice_command(endswith: str, type_: str, url: str, tips: str = None, help_tips: str = None):
    ...
    command.__paimon_meta__ = {
        'name': endswith,
        'description': f"查看该{help_tips}的{endswith}",

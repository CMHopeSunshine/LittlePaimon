...
from LittlePaimon.utils.enka import get_artifact_suit
...
def draw_dmg_pic(dmg: Dict[str, Union[tuple, list]]):
    ...
    img = PMImage(size=(948, height + 80), color=(0, 0, 0, 50), mode='RGBA')
    img.circle_corner(5)
    img.draw_line((250, 0), (250, 948), (255, 255, 255, 75), 2)
    img.draw_line((599, 0), (599, 60), (255, 255, 255, 75), 2)
    img.draw_line((0, 60), (948, 60), (255, 255, 255, 75), 2)
    img.text('伤害计算', (0, 250), (0, 60), font_manager.get('hywh.ttf', 30), 'white', 'center')
    img.text('期望伤害', (250, 599), (0, 60), font_manager.get('hywh.ttf', 30), 'white', 'center')
    img.text('暴击伤害', (599, 948), (0, 60), font_manager.get('hywh.ttf', 30), 'white', 'center')
    i = 1
    for describe, dmg_list in dmg.items():
        img.draw_line((0, 60 * i), (948, 60 * i), (255, 255, 255, 75), 2)
        img.text(describe, (0, 250), (60 * i, 60 * (i + 1)), font_manager.get('hywh.ttf', 30), 'white', 'center')
        if len(dmg_list) == 1:
            if describe == '额外说明':
                img.text(dmg_list[0], (250, 948), (60 * i, 60 * (i + 1)), font_manager.get('hywh.ttf', 30), 'white',
                         'center')
            else:
                img.text(dmg_list[0], (250, 948), (60 * i, 60 * (i + 1)), font_manager.get('number.ttf', 30), 'white',
                         'center')
        else:
            img.draw_line((599, 60 * i), (599, 60 * (i + 1)), (255, 255, 255, 75), 2)
            img.text(dmg_list[0], (250, 599), (60 * i, 60 * (i + 1)), font_manager.get('number.ttf', 30), 'white',
                     'center')
            img.text(dmg_list[1], (599, 948), (60 * i, 60 * (i + 1)), font_manager.get('number.ttf', 30), 'white',
                     'center')
        i += 1
